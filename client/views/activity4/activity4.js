...
Activity4.prototype.update = function(markersDetector) {
...
Activity4.prototype.setRenderingCallback = function(context, callback){
...
Activity4.prototype.updateReadyInfo = function(markers){
...
Activity4.prototype.checkSolution = function(views){
    var correct = [];
    var wrong = [];
    var userSol = [];
    var correctSol = null;
...
Activity4.prototype.isAllCorrect = function(correct, wrong, verticalEdge) {
	var isCorrect = true;
